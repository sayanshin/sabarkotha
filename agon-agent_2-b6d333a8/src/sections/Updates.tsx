      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 pb-24 pt-24 sm:pt-32">
        <div className="paper-ribbon">
          <SectionHeading
            kicker="Updates"
            title="আজকের বড় খবর"
            sub="দিন বদলায়, খবর আসে, বদলায় সময়ের রং, <br /> নতুন দিনের নতুন কথায় দেখুন তাদের ঢং। <br /> দেশের খবর, দশের কথা, থাকুক সবার ঘরে, <br /> সবার কথা, প্রতিদিন—আপন করে ধরে।"
          />
        </div>
                  ...
                  <div className="paper-card overflow-hidden p-0">
                    ...
                    <div className="p-4 sm:p-5">
                      ...
                      <p className="mt-1.5 flex items-center gap-1.5 text-xs font-medium text-ink-soft">
                        ...
                        {youtubeId(url) ? 'ইন-অ্যাপ প্লেয়ারে দেখুন' : 'ইউটিউবে সরাসরি দেখুন'}
                      </p>
                    </div>
                  </div>
                </motion.article>
