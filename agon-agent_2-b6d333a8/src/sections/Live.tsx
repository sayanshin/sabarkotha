...
export default function Live() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        // Fetch API live metadata
        const data = await api.live.get();
        setLiveData(data);

        // Fetch custom playlist JSON from public directory
        ...
        console.error('Error loading live data or playlist:', err);
      }
    }
    loadData();
  }, []);
    ...
    <section id="live" ref={ref} className="relative scroll-mt-24 overflow-hidden py-24 sm:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4">
        <SectionHeading
          ...
          sub="সব সময়ের সেরা খবর, সরাসরি আপনার পর্দায়"
        />
          ...
          {embedUrl ? (
            ...
            <div className="flex min-h-[360px] flex-col items-center justify-center p-8 text-center text-paper-soft">
              ...
              <h3 className="font-editorial text-2xl font-bold">
                {liveData?.title || 'এই মুহূর্তে কোনো লাইভ নেই'}
              </h3>
